...
func request_UrlShortenerService_GenerateShortCode_0(ctx context.Context, marshaler runtime.Marshaler, client UrlShortenerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.GenerateShortCode(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func local_request_UrlShortenerService_GenerateShortCode_0(ctx context.Context, marshaler runtime.Marshaler, server UrlShortenerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.GenerateShortCode(ctx, &protoReq)
	return msg, metadata, err
...
func request_UrlShortenerService_GenerateShortCodeAccount_0(ctx context.Context, marshaler runtime.Marshaler, client UrlShortenerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.GenerateShortCodeAccount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func local_request_UrlShortenerService_GenerateShortCodeAccount_0(ctx context.Context, marshaler runtime.Marshaler, server UrlShortenerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.GenerateShortCodeAccount(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterUrlShortenerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UrlShortenerServiceServer) error {
	...
	mux.Handle("POST", pattern_UrlShortenerService_GenerateShortCode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/online.gonlink.UrlShortenerService/GenerateShortCode", runtime.WithHTTPPathPattern("/shorten-service/api/v1/generate-shortcode"))
		if err != nil {
	...
	mux.Handle("POST", pattern_UrlShortenerService_GenerateShortCodeAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/online.gonlink.UrlShortenerService/GenerateShortCodeAccount", runtime.WithHTTPPathPattern("/shorten-service/api/v1/account-generate-shortcode"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UrlShortenerService_GetOriginalUrl_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/online.gonlink.UrlShortenerService/GetOriginalUrl", runtime.WithHTTPPathPattern("/shorten-service/api/v1/get-original-url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterQRCodeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QRCodeServiceServer) error {
	...
	mux.Handle("POST", pattern_QRCodeService_GetStringBase64Image_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/online.gonlink.QRCodeService/GetStringBase64Image", runtime.WithHTTPPathPattern("/shorten-service/api/v1/gen-qr"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterUrlShortenerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UrlShortenerServiceClient) error {
	...
	mux.Handle("POST", pattern_UrlShortenerService_GenerateShortCode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/online.gonlink.UrlShortenerService/GenerateShortCode", runtime.WithHTTPPathPattern("/shorten-service/api/v1/generate-shortcode"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UrlShortenerService_GenerateShortCodeAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/online.gonlink.UrlShortenerService/GenerateShortCodeAccount", runtime.WithHTTPPathPattern("/shorten-service/api/v1/account-generate-shortcode"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UrlShortenerService_GetOriginalUrl_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/online.gonlink.UrlShortenerService/GetOriginalUrl", runtime.WithHTTPPathPattern("/shorten-service/api/v1/get-original-url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UrlShortenerService_GenerateShortCode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shorten-service", "api", "v1", "generate-shortcode"}, ""))

	pattern_UrlShortenerService_GenerateShortCodeAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shorten-service", "api", "v1", "account-generate-shortcode"}, ""))

	pattern_UrlShortenerService_GetOriginalUrl_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shorten-service", "api", "v1", "get-original-url"}, ""))
)
...
func RegisterQRCodeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QRCodeServiceClient) error {
	...
	mux.Handle("POST", pattern_QRCodeService_GetStringBase64Image_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/online.gonlink.QRCodeService/GetStringBase64Image", runtime.WithHTTPPathPattern("/shorten-service/api/v1/gen-qr"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_QRCodeService_GetStringBase64Image_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shorten-service", "api", "v1", "gen-qr"}, ""))
)
