...
func request_Traffic_GetRealTimeTrafficAccount_0(ctx context.Context, marshaler runtime.Marshaler, client TrafficClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RealTimeTrafficAccountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetRealTimeTrafficAccount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Traffic_GetRealTimeTrafficAccount_0(ctx context.Context, marshaler runtime.Marshaler, server TrafficServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RealTimeTrafficAccountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetRealTimeTrafficAccount(ctx, &protoReq)
	return msg, metadata, err

}

func request_Traffic_GetDayTrafficAccount_0(ctx context.Context, marshaler runtime.Marshaler, client TrafficClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DayTrafficAccountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetDayTrafficAccount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Traffic_GetDayTrafficAccount_0(ctx context.Context, marshaler runtime.Marshaler, server TrafficServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DayTrafficAccountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetDayTrafficAccount(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTrafficHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TrafficServer) error {
	...
	mux.Handle("POST", pattern_Traffic_GetRealTimeTrafficAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/online.gonlink.Traffic/GetRealTimeTrafficAccount", runtime.WithHTTPPathPattern("/api/v1/traffics/real-time-account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Traffic_GetRealTimeTrafficAccount_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Traffic_GetRealTimeTrafficAccount_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_Traffic_GetDayTrafficAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/online.gonlink.Traffic/GetDayTrafficAccount", runtime.WithHTTPPathPattern("/api/v1/traffics/day-account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Traffic_GetDayTrafficAccount_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Traffic_GetDayTrafficAccount_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTrafficHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TrafficClient) error {
	...
	mux.Handle("POST", pattern_Traffic_GetRealTimeTrafficAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/online.gonlink.Traffic/GetRealTimeTrafficAccount", runtime.WithHTTPPathPattern("/api/v1/traffics/real-time-account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Traffic_GetRealTimeTrafficAccount_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_Traffic_GetDayTrafficAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/online.gonlink.Traffic/GetDayTrafficAccount", runtime.WithHTTPPathPattern("/api/v1/traffics/day-account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Traffic_GetDayTrafficAccount_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Traffic_GetRealTimeTrafficAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "traffics", "real-time-account"}, ""))

	pattern_Traffic_GetDayTrafficAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "traffics", "day-account"}, ""))
)
...
var (
	...
	forward_Traffic_GetRealTimeTrafficAccount_0 = runtime.ForwardResponseMessage

	forward_Traffic_GetDayTrafficAccount_0 = runtime.ForwardResponseMessage
)
